...
function lullaby_mobs:mobs/spectral_assassin/equip/nothing
...
execute if score mobs_loot lullaby_mobs.settings matches 1 run data modify entity @s DeathLootTable set value "lullaby_mobs:mobs/spectral_assassin"