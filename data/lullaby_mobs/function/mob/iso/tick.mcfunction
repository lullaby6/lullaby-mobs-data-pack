...
execute if entity @s[tag=lullaby_mobs.iso.shield.inactive] unless predicate utils:has/effect/mining_fatigue run function lullaby_mobs:mob/iso/shield/activate
